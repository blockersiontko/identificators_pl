...
from identificators_pl import REGONValidator


# Poprawne (zweryfikowane ręcznie) numery REGON wg algorytmów w regon.py
VALID_REGON_9 = ["000331501"]          # rzeczywisty REGON GUS, suma kontrolna zgodna z wagami 8-cyfrowymi
VALID_REGON_14 = ["00033150100017"]    # 9-cyfrowy prefiks + jednostka lokalna, suma kontrolna zgodna z WEIGHTS_14
